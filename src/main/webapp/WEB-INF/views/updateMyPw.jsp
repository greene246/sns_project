        ...
        <form method="post">
            <div class="content">
                <div class="updateUser">
                    ...
                    <div class="__pw">새 비밀번호</div> <input type="password" name="pw_new" id="pw_new" required><br>
                    <div class="___pw">비밀번호 재확인</div> <input type="password" name="pw_check" id="pw_check" required><br>
